package fr.maxlego08.worldprotection.listener;
...
public class AdapterListener extends ZUtils implements Listener {
    ...
    public AdapterListener(WorldProtectionPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void onWorldChange(PlayerChangedWorldEvent event) {
        this.plugin.getListenerAdapters().forEach(adapter -> adapter.onWorldChange(event, event.getPlayer(), event.getFrom(), event.getPlayer().getWorld()));
    }
