package fr.maxlego08.worldprotection.inventory;

import java.util.HashMap;
import java.util.Map;

import fr.maxlego08.worldprotection.WorldProtectionPlugin;
import fr.maxlego08.worldprotection.zcore.utils.builder.ItemBuilder;
...
import fr.maxlego08.worldprotection.exceptions.InventoryOpenException;
import fr.maxlego08.worldprotection.zcore.utils.ZUtils;
import fr.maxlego08.worldprotection.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.worldprotection.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected WorldProtectionPlugin plugin;
	...
	protected InventoryResult preOpenInventory(WorldProtectionPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(WorldProtectionPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, WorldProtectionPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, WorldProtectionPlugin plugin, Player player) {
	}
