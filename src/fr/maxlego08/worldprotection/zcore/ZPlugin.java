package fr.maxlego08.worldprotection.zcore;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import fr.maxlego08.worldprotection.WorldProtectionPlugin;
import fr.maxlego08.worldprotection.command.CommandManager;
import fr.maxlego08.worldprotection.command.VCommand;
import fr.maxlego08.worldprotection.exceptions.ListenerNullException;
import fr.maxlego08.worldprotection.inventory.VInventory;
import fr.maxlego08.worldprotection.inventory.ZInventoryManager;
import fr.maxlego08.worldprotection.listener.AdapterListener;
...
import fr.maxlego08.worldprotection.placeholder.Placeholder;
import fr.maxlego08.worldprotection.zcore.enums.EnumInventory;
import fr.maxlego08.worldprotection.zcore.logger.Logger;
import fr.maxlego08.worldprotection.zcore.logger.Logger.LogType;
import fr.maxlego08.worldprotection.zcore.utils.gson.LocationAdapter;
import fr.maxlego08.worldprotection.zcore.utils.gson.PotionEffectAdapter;
import fr.maxlego08.worldprotection.zcore.utils.plugins.Plugins;
import fr.maxlego08.worldprotection.zcore.utils.storage.NoReloadable;
...
public abstract class ZPlugin extends JavaPlugin {
    ...
    protected void preEnable() {
        ...
        LocalPlaceholder.getInstance().setPlugin((WorldProtectionPlugin) this);
        ...
        this.commandManager = new CommandManager((WorldProtectionPlugin) this);
        this.inventoryManager = new ZInventoryManager((WorldProtectionPlugin) this);

        /* Add Listener */
        this.addListener(new AdapterListener((WorldProtectionPlugin) this));
