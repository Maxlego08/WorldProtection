package fr.maxlego08.worldprotection.zcore.utils.inventory;
...
public abstract class PaginateInventory<T> extends VInventory {
	...
	@Override
	public InventoryResult openInventory(WorldProtectionPlugin plugin, Player player, int page, Object... args)
