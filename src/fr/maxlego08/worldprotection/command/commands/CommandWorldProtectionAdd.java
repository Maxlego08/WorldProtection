...
public class CommandWorldProtectionAdd extends VCommand {

    public CommandWorldProtectionAdd(WorldProtectionPlugin plugin) {
        super(plugin);
        this.setPermission(Permission.WORLDPROTECTION_ADD);
    ...
    protected CommandType perform(WorldProtectionPlugin plugin) {
        ...
        plugin.getWorldManager().addPlayer(player, offlinePlayer);
