package fr.maxlego08.worldprotection.command;
...
import fr.maxlego08.worldprotection.zcore.utils.commands.Arguments;
import fr.maxlego08.worldprotection.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.worldprotection.zcore.utils.commands.CommandType;
import fr.maxlego08.worldprotection.zcore.utils.commands.Tab;
...
public abstract class VCommand extends Arguments {
    ...
    protected final WorldProtectionPlugin plugin;
    /**
     ...
     */
    public VCommand(WorldProtectionPlugin plugin) {
        super();
        this.plugin = plugin;
    }
     ...
     */
    public CommandType prePerform(WorldProtectionPlugin plugin, CommandSender commandSender, String[] args) {
     ...
     * @return the command type.
     */
    protected abstract CommandType perform(WorldProtectionPlugin plugin);
     ...
     */
    public List<String> toTab(WorldProtectionPlugin plugin, CommandSender sender, String[] args) {
